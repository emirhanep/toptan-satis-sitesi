...
if($existVal == 0) {
    $isim = "admin";  $soyad = "admin";   $mail = "admin@admin.com";  $sifre = "12345"; $tel = "123456"; $yetki = 2; $durum = 1;
    ...
    $adres = NULL;  $adres = NULL;  $postakodu = NULL;  $sehir = NULL;  $ulke = NULL;  $sirket = NULL; 
